    ...
    <div className="flex gap-3 justify-center flex-wrap mt-6">
      {examples.map((example, index) => (
        <button
          ...
          className="cursor-pointer bg-white text-black hover:text-blue-500 px-6 py-2 rounded-4xl hover:bg-gray-50 transition-all duration-200 border border-gray-300 hover:border-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {example.label}
        </button>
      ))}
